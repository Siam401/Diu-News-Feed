   ...
   // dd($latest);
    ...
    public function home()
    {
        ...
        $slider=Slider::all();
          ...
          return view('frontend.index',compact('data','latest','popular','date','cat','frontPostByCategory1','frontPostByCategory2','frontPostByCategory3','frontPostByCategory4','inter_breaking_posts','slider'));
    }
